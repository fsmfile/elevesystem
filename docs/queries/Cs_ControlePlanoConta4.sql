SELECT tbl_cad_Planocontas.Nome_PlanoContas, Sum(Nz([Valor_LancCaixa],0)) AS Valor4
...
HAVING (((tbl_cad_Planocontas.Nome_PlanoContas)=[Formulários]![frm_ControlePlanoConta]![CxPC1]));
